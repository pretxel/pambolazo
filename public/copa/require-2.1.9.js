...
urlArgs: ['v=', '635367003755128020'].join('')
});
...
var preferredPlatform = Cookie.get('FIFA_PLFR');
...
Cookie.set('FIFA_PLFR', "desktop", 365, '/');
} else if (qs.indexOf("preferredPlatform=mobile") != -1) {
Cookie.set('FIFA_PLFR', "mobile", 365, '/');
}
}
...
var products = ";" + sid + ":" + s.prop11 + ":" + sk + sa + sact + ";;;event27=1";
if (!!s.products == false) {
s.products = "";
}
else {
